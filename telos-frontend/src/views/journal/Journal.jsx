...
const Journal = () => {
  ...
  return (
    <div className={styles.Journal}>
      <div className={styles.HalfJournal}>
        <ArrowBackIcon className={styles.ArrowLeft} onClick={handleLeftNav} />
        <DatePicker
      ...
      <div className={styles.HalfJournal}>
        ...
        <ArrowForwardIcon className={styles.ArrowRight} onClick={handleRightNav} />
      </div>
    </div>
  );
};
