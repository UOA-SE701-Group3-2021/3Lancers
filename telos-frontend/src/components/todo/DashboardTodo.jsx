      ...
      <Box className="container">
        ...
        <List className={classes.root}>
          {newItem.map((value) => {
            ...
            return (
              <ListItem className="listItem" key={value.name} role={undefined} dense button onClick={handleToggle(value.name)} >
                {value.onGoing ? (
                    <ListItemIcon>
                    <Checkbox
                        edge="start"
                ...
                {value.onGoing ? (
                        ...
                        <ListItemText primaryTypographyProps={{ style: outdated }} id={labelId} primary={` ${value.name}`} secondary={` ${value.due}`}/>
                    )}
                {value.onGoing ? (
                        <ListItemSecondaryAction>
                            <IconButton edge="end" aria-label="comments" aria-controls="simple-menu" aria-haspopup="true" onClick={handleOption}>
                                <MoreVertIcon />
                            </IconButton>
                      </ListItemSecondaryAction>
                        ...
                        <ListItemSecondaryAction>
                            <IconButton edge="end" aria-label="warning" aria-controls="simple-menu" aria-haspopup="true" onClick={handleOption}>
