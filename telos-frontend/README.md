...
1. Open the command prompt and set the working directory as the `telos-frontend` directory under your cloned repository folder `3lancers`. (`cd 3lancers/telos-frontend`)
